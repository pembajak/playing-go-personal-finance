...
type User struct {
	...
	Email     string         `json:"email" deepcopier:"email" validate:"required,email,min=1,max=100"`
	FullName  string         `json:"full_name" deepcopier:"FullName" validate:"required,min=1,max=100"`
